-- 🚀 SUPABASE COMPATIBLE FIXES SCRIPT - SAFE VERSION
...
BEGIN
    IF NOT EXISTS (
        ...
        AND policyname = 'Users can view their own credit history'
    ) THEN
    ...
    IF NOT EXISTS (
        ...
        WHERE schemaname = 'public' 
        AND tablename = 'credit_history' 
        AND policyname = 'Service role can insert credit history'
    ) THEN
