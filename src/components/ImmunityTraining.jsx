        ...
        <div className="p-6 border relative overflow-hidden" style={{
          ...
          <div className="flex gap-3">
            <button 
              ...
              className="flex-1 bg-white/10 hover:bg-white/20 text-stone-100 font-normal py-3 px-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2"
              style={{
