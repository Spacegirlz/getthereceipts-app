          ...
          <div className="rounded-xl p-6 border border-white/8" style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '12px' }}>
            <div className="text-center">
              ...
              <button 
                ...
                className="text-xs text-stone-100/70 hover:text-stone-100 flex items-center gap-1 mx-auto transition-colors"
              >
        ...
        >
          ...
          <div className="flex gap-2">
            <button 
              ...
              className="flex-1 bg-white/10 hover:bg-white/20 text-stone-100 font-normal py-2 px-3 rounded-xl transition-all duration-300 flex items-center justify-center gap-2"
              style={{
