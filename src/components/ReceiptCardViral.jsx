...
const ReceiptCardViral = memo(({ results }) => {
  ...
  return (
    ...
    >
      <div className={`relative rounded-[24px] p-8 text-stone-100 overflow-hidden`}
        style={{
        ...
        {isSavage && (
          <div className="absolute top-4 right-4 z-20">
            <motion.div 
              ...
              className="bg-red-600 text-stone-100 text-xs font-black uppercase px-3 py-1 rounded-full shadow-lg"
            >
              SAVAGE
            </motion.div>
          </div>
        ...
        <div className="relative z-10">
          ...
          {/* WATERMARK */}
          <div className="text-center">
            <p className="text-xs text-stone-100/40 tracking-widest">
              getthereceipts.com
            </p>
          </div>
        </div>
