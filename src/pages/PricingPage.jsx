          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-slate-900/60 via-green-900/20 to-slate-900/60 backdrop-blur-xl rounded-3xl border border-green-500/20 p-12 md:p-16 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center max-w-3xl mx-auto">
                <Button
                  onClick={() => navigate('/chat-input')}
                  className="flex-1 bg-white/10 border-2 border-white/30 text-white hover:bg-white/20 hover:border-white/50 font-bold py-4 px-8 rounded-xl transition-all duration-300 backdrop-blur-sm shadow-lg"
                >
                  Start Free
                </Button>
                <Button
                  className="flex-1 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 shadow-xl shadow-blue-500/30 transform hover:scale-105"
                  onClick={() => handleCheckout('price_1RzgEZG71EqeOEZejcCAFxQs', 'Premium')}
                >
                  Go Unlimited
                </Button>
                <Button
                  className="flex-1 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 shadow-xl shadow-purple-500/30 transform hover:scale-105"
                  onClick={() => handleCheckout('price_1RzgBYG71EqeOEZer7ojcw0R', 'OG Founder')}
                >
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-slate-800/80 via-purple-900/30 to-slate-800/80 backdrop-blur-xl rounded-3xl border-2 border-purple-500/30 p-10 md:p-12 shadow-2xl shadow-purple-500/10">
              <div className="text-center mb-8">
                <div className="text-3xl mb-4">🔒</div>
                <h3 className="text-2xl font-bold text-white mb-6">Your privacy comes first.</h3>
